...
const Navbar = () => {
  ...
  return (
    <header className="w-full mx-auto  px-4 fixed top-0 z-50 sm:px-20 shadow bg-white dark:bg-stone-600 dark:border-b dark:border-stone-600">
      <div className="justify-between md:items-center md:flex">
        <div>
          <div className="flex items-centered justify-between py-3">
            <div className="md:py-5 md:block">
              <h2 className="text-2xl font-bold">Andrei-Stefan Panait</h2>
            </div>
